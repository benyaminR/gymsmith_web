...
import 'package:gymsmith_web/pdp/mobile/product_image.dart' as Mobile;
import 'package:gymsmith_web/pdp/mobile/right_side_product_detail_card.dart' as Mobile;
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        SizedBox(height: 18,),
        Mobile.ProductImage(images: highResImages.map((e) => e.toString()).toList(),sizingInformation: sizingInformation,),
        SizedBox(height: 26,),
        Mobile.RightSideProductDetailCard(pdpData:pdpData,sizingInformation: sizingInformation,),
        SizedBox(height: 66,),
        DealsOfTheDayWidget(),
        SizedBox(height: 125,),
      ],
