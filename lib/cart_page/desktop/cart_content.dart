...
import 'bottom_amount_and_price_widget.dart' as Desktop;
import 'cart_list.dart' as Desktop;
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          width: 625,
          child: Align(
            child: Desktop.BottomAmountAndPriceWidget(),
